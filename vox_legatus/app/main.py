...
from app.recrutation.presentation.endpoints import submission, graders_group, grader, grade, ticket
...
app.include_router(grade.router, prefix="/api/grade", tags=["grade"])
